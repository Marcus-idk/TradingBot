...
### `tests/__init__.py`
- Purpose: Tests package for TradingBot.
- Tests: (none)
...
- Fixtures:
  ...
  - `temp_db` - Initialize a temporary TradingBot database and yield its path.
...
- Tests:
  **TestClassifyUsSession**
  - `test_core_windows` - Test core trading windows across EDT and EST timezones.
