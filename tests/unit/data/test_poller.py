...
@pytest.mark.asyncio
async def test_poll_once_stores_and_updates_watermark(temp_db):
...
@pytest.mark.asyncio
async def test_poll_once_collects_errors(temp_db):
...
@pytest.mark.asyncio
async def test_poll_once_no_data_no_watermark(temp_db):
...
@pytest.mark.asyncio
async def test_poller_quick_shutdown(temp_db):
...
@pytest.mark.asyncio
async def test_poller_custom_poll_interval(temp_db):
